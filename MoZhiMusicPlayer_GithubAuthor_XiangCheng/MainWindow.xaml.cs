...
namespace MoZhiMusicPlayer_GithubAuthor_XiangCheng
{
    ...
    public partial class MainWindow : Window
    {
        ...
        private void Button_Load_UserData_MouseLeftButtonDown(object sender, MouseButtonEventArgs e)
        {
            ...
            MediaElement_Song.LoadedBehavior = MediaState.Close;
            MediaElement_Song.Source = null;
                ...
                foreach (MusicData musicData in musicDataList)
                {
                    ...
                    try
                    {
                        ...
                        userControl_Main_Home_Left_MyMusic_SongInfo_Synchronous.
                            ListBox_Music_Urls_DownLoad_Results_Display.Items.Add("下载成功：" + musicData.musicUrl);
                    ...
                    {
                        userControl_Main_Home_Left_MyMusic_SongInfo_Synchronous.
                            ListBox_Music_Urls_DownLoad_Results_Display.Items.Add("下载出错：" + musicData.musicUrl + "，错误信息：" + ex.Message);

                        MessageBox.Show("下载出错：" + musicData.musicUrl + "，错误信息：" + ex.Message);
                    }
                }
            }
                            ...
                            if (ListBox_MRC_Song_MRC_Time[musicPlayer_Main_UserControl.ListView_Temp_MRC.SelectedIndex] != 0)
                            {
                                try
                                {
                                        ...
                                        Array_Morebyte_Text.Count; i++)
                                    {
                                        ...
                                        UserControl_Mrc_Byte mrc_Byte = new UserControl_Mrc_Byte();

                                        //设置文本
                                        mrc_Byte.TextBlock_1.Text = dao_ListBox_Temp_MRC.mrc_Line_Info[musicPlayer_Main_UserControl.ListView_Temp_MRC.SelectedIndex - dao_ListBox_Temp_MRC.LRC_Text_Null_Nums].
                                            Array_Morebyte_Text[i].ToString();

                                        //设置动画
                                        Storyboard storyboard = (Storyboard)mrc_Byte.TextBlock_1.FindName("Text_Storyboard");              
                                        storyboard.Duration = new Duration(new TimeSpan(0,0,0,0, temp_Duration));
                                        //
                                        DoubleAnimationUsingKeyFrames doubleAnimationUsingKeyFrames = (DoubleAnimationUsingKeyFrames)mrc_Byte.TextBlock_1.FindName("Text_DoubleAnimation");
